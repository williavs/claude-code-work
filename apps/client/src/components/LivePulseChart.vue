<template>
  <div class="bg-gradient-to-r from-[var(--theme-bg-primary)] to-[var(--theme-bg-secondary)] px-3 py-4 mobile:py-3 shadow-lg">
    <div class="flex items-center justify-between mb-3">
      ...
      <div class="flex gap-1 items-center" role="tablist" aria-label="Time range selector">
        <button
          ...
          :class="[
            ...
            timeRange === range
              ...
              : 'bg-[var(--theme-bg-tertiary)] text-[var(--theme-text-secondary)] hover:bg-[var(--theme-bg-quaternary)] hover:text-[var(--theme-text-primary)]'
          ]"
          role="tab"
